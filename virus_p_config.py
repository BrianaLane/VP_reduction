...
redux_dir        = "redux_20160404"	 	#name of the folder reduction is run 
date_folder      = "20160404"		#date folder containing raw data 

#Choose the spectral range of your VIRUS-P data 
spec_range   	 = [4700,7200] 		#Spectral range of that nights observations in angstroms

lines_file       = "/Users/Briana/Documents/Grad_School/VIRUS_P/VP_APR_2016/vp_new_04/lines.apr16"	#path to the lines file for this data set
...
rmCosmics	 	= False  		#[True/False] If True the program L.A.Cosmic is used to eliminate cosmic rays (default: True)
...
# make cube opts #
#----------------#
#these need to be the length of the number of dithers you have (the science_frame list) 
airmass_lis 	= [1.0,]
seeing_lis 		= [3.0,]
